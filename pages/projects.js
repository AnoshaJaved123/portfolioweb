...
<div className="container my-24 px-6 mx-auto">
  ...
  <div className="flex justify-center items-center h-full">
    ...
    <div className="flex flex-wrap items-center">
      ...
      <div className="grow-0 shrink-0 basis-auto w-full lg:w-5/12 mb-12 lg:mb-0 md:px-6">
        ...
        <Image src={'/assets/img/shop34.PNG'}  alt="Picture of the author" width={500} height={200}></Image> 
        <Image src={'/assets/img/shop99.PNG'}  alt="Picture of the author" width={500} height={200}></Image>  
        <Image src={'/assets/img/shop2.PNG'}  alt="Picture of the author" width={500} height={200}></Image>  
  ...
  <div className="flex justify-center items-center h-full">
    ...
    <div className="grow-0 shrink-0 basis-auto w-full lg:w-5/12 mb-12 lg:mb-0 md:px-6">
     ...
     <Image src={'/assets/img/react121.PNG'}  alt="Picture of the author" width={300} height={400}></Image>  

     <Image src={'/assets/img/react4.PNG'}  alt="Picture of the author" width={500} height={200}></Image>  
